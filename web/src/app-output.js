...
$(function() {
  ...
  watchEvent.watch(function(error, result) {
  	...
  	$('#message').text("money: " + web3.eth.getBalance(beneficiaryAccount));
  });
  ...
  watchAccount = web3.eth.filter({ address: web3.eth.defaultAccount });
  watchAccount.watch(function(error, result) {
